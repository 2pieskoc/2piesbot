// ==UserScript==
// @name          Reference Tab Addon
// @namespace     TwoPiesPrimeByDarkness
// @description   Extra tab for 2pies Prime by Darkness. Restores the Reference tab, TR unique card display, throne card descriptions and old bot card tooltips.
// @include       *://*.rycamelot.com/*
// @include       *://apps.facebook.com/kingdomsofcamelot/*
// @include       *://*.playgardencitygames.com/*
// @connect       *
// @grant         none
// @run-at        document-end
// @license       CC-BY-4.0
// @version       5.0.2-reference-addon
// @tabversion    20260519
// ==/UserScript==

/*
  2pies Prime Reference Tab Addon
  ------------------------------------------------------------
  Add this through the bot's Additional Tabs manager, not as a
  normal Tampermonkey-only install. The bot loads extra tabs by
  fetching this file and evaling it inside the bot scope.

  Purpose:
  - restores Tabs.Reference
  - restores TR unique card viewer
  - restores Tabs.Reference.BuildThroneCard
  - restores Tabs.Reference.DisplayTRCard
  - restores ksoItems throne card descriptions/tooltips
*/

(function twoPiesPrimeReferenceTabAddon(){
    if (typeof Tabs === 'undefined') {
        try { console.warn('2pies Prime Reference Tab Addon: add this URL inside the bot Additional Tabs manager, then refresh KoC.'); } catch (e) {}
        return;
    }
...
m += '<TR><TD class=xtab>&nbsp;</td><td align=right class=xtab>'+tx('Camelot Version')+':</td><td class=xtab><b>'+anticd.getKOCversion()+'</b></td><td class=xtab align=right>'+tx('2Pies Version')+':</td><td class=xtab><b>'+Version+'</b></td></tr>';
...
return D.join("");
    ...
    try {
        if (typeof actionLog === 'function') actionLog('2pies Prime Reference Tab Addon loaded', 'GENERAL');
    } catch (e) {}
})();
